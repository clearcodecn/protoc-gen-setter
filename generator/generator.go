...
import (
	...
	"github.com/clearcodecn/protoc-gen-setter/generator/remap"
...
func (g *Generator) generate(file *FileDescriptor) {
	...
	g.P("// This is a plugin of setter method implement")
	g.P()
...
type fieldCommon struct {
	...
	setterName string // Name of setter.
...
func (f *simpleField) setter(g *Generator, mc *msgCtx) {
	...
	g.P("func (m *", mc.goName, ") ", f.setterName, "(val "+tname+" ){")
